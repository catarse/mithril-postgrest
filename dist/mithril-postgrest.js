...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/postgrest.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var mithril_stream__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! mithril/stream */ "./node_modules/mithril/stream.js");
...
/* harmony import */ var _vms_filtersVM__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./vms/filtersVM */ "./src/vms/filtersVM.js");
/* harmony import */ var _vms_paginationVM__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./vms/paginationVM */ "./src/vms/paginationVM.js");
/* harmony import */ var mithril__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! mithril */ "./node_modules/mithril/mithril.js");
...
function Postgrest(mithrilInstance) {
  var m = mithrilInstance || mithril__WEBPACK_IMPORTED_MODULE_7___default.a;
  var postgrest = {};

  var token = mithril_stream__WEBPACK_IMPORTED_MODULE_3___default()(),
      mergeConfig = function mergeConfig(config, options) {
    return options && underscore__WEBPACK_IMPORTED_MODULE_4__["default"].isFunction(options.config) ? underscore__WEBPACK_IMPORTED_MODULE_4__["default"].compose(options.config, config) : config;
  },
      addHeaders = function addHeaders(headers) {
    return function (xhr) {
      underscore__WEBPACK_IMPORTED_MODULE_4__["default"].each(headers, function (value, key) {
    ...
    return underscore__WEBPACK_IMPORTED_MODULE_4__["default"].extend({}, options, {
    ...
    var loader = mithril_stream__WEBPACK_IMPORTED_MODULE_3___default()(defaultState);
    ...
    loader.load = function () {
      return new _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_2___default.a(function (resolve, reject) {
        loader(true);
        requestFunction(underscore__WEBPACK_IMPORTED_MODULE_4__["default"].extend({}, options, {
          background: false
        })).then(function (data) {
          loader(false);
          resolve(data);
  ...
  postgrest.init = function (apiPrefix, authenticationOptions) {
    ...
    postgrest.request = function (options) {
      var errorHandler = function errorHandler(xhr) {
        try {
          ...
          return _babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()({
            hint: null,
            details: null,
            code: 0,
      ...
      var configHeadersToAdd = addConfigHeaders(globalHeader, underscore__WEBPACK_IMPORTED_MODULE_4__["default"].extend({
    ...
    var authenticationRequested = mithril_stream__WEBPACK_IMPORTED_MODULE_3___default()(false);

    postgrest.authenticate = function (delegatedDeferred) {
      var deferred = delegatedDeferred || new _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_2___default.a(function (resolve, reject) {
        var workingCall = function workingCall() {
          if (token()) {
            ...
            m.request(underscore__WEBPACK_IMPORTED_MODULE_4__["default"].extend({}, authenticationOptions)).then(function (data) {
            ...
            _babel_runtime_corejs3_core_js_stable_set_timeout__WEBPACK_IMPORTED_MODULE_0___default()(workingCall, 250);
          }
        };
    ...
    postgrest.loader = underscore__WEBPACK_IMPORTED_MODULE_4__["default"].partial(createLoader, postgrest.request);
    postgrest.loaderWithToken = underscore__WEBPACK_IMPORTED_MODULE_4__["default"].partial(createLoader, postgrest.requestWithToken);
    ...
    postgrest.model = function (name) {
      var paginationHeaders = function paginationHeaders(page, pageSize) {
        ...
        return {
          ...
          pageSize = mithril_stream__WEBPACK_IMPORTED_MODULE_3___default()(10),
          nameOptions = {
        url: '/' + name
      },
        ...
        var extraHeaders = underscore__WEBPACK_IMPORTED_MODULE_4__["default"].extend({}, {
          'Prefer': 'count=none'
        }, headers, paginationHeaders(page, pageSize));

        return addConfigHeaders(extraHeaders, underscore__WEBPACK_IMPORTED_MODULE_4__["default"].extend({}, options, nameOptions, {
          method: 'GET',
          data: data
        }));
      },
        ...
        return postgrest.request(underscore__WEBPACK_IMPORTED_MODULE_4__["default"].extend({}, _options, nameOptions, {
          method: 'OPTIONS'
        }));
      },
        ...
        var extraHeaders = underscore__WEBPACK_IMPORTED_MODULE_4__["default"].extend({}, representationHeader, headers);
        ...
        return querystring(filters, addConfigHeaders(extraHeaders, underscore__WEBPACK_IMPORTED_MODULE_4__["default"].extend({}, options, nameOptions, {
          method: 'DELETE'
        })));
      },
      ...
      return {
        ...
        getPage: underscore__WEBPACK_IMPORTED_MODULE_4__["default"].compose(postgrest.request, getPageOptions),
        getRow: underscore__WEBPACK_IMPORTED_MODULE_4__["default"].compose(postgrest.request, getRowOptions),
        patch: underscore__WEBPACK_IMPORTED_MODULE_4__["default"].compose(postgrest.request, patchOptions),
        post: underscore__WEBPACK_IMPORTED_MODULE_4__["default"].compose(postgrest.request, postOptions),
        deleteRequest: underscore__WEBPACK_IMPORTED_MODULE_4__["default"].compose(postgrest.request, deleteOptions),
        getPageWithToken: underscore__WEBPACK_IMPORTED_MODULE_4__["default"].compose(postgrest.requestWithToken, getPageOptions),
        getRowWithToken: underscore__WEBPACK_IMPORTED_MODULE_4__["default"].compose(postgrest.requestWithToken, getRowOptions),
        patchWithToken: underscore__WEBPACK_IMPORTED_MODULE_4__["default"].compose(postgrest.requestWithToken, patchOptions),
        postWithToken: underscore__WEBPACK_IMPORTED_MODULE_4__["default"].compose(postgrest.requestWithToken, postOptions),
        deleteWithToken: underscore__WEBPACK_IMPORTED_MODULE_4__["default"].compose(postgrest.requestWithToken, deleteOptions),
        options: options
      };
    };
  ...
  postgrest.filtersVM = _vms_filtersVM__WEBPACK_IMPORTED_MODULE_5__["default"];
  postgrest.paginationVM = Object(_vms_paginationVM__WEBPACK_IMPORTED_MODULE_6__["default"])(mithrilInstance);
  return postgrest;
}

/* harmony default export */ __webpack_exports__["default"] = (Postgrest);

/***/ }),

/***/ "./src/vms/filtersVM.js":
/*!******************************!*\
  !*** ./src/vms/filtersVM.js ***!
  \******************************/
/*! exports provided: default */
...
var filtersVM = function filtersVM(attributes) {
  var newVM = {},
    ...
    var innerProp = mithril_stream__WEBPACK_IMPORTED_MODULE_2___default()(''),
    ...
    filterProp.toFilter = function () {
      ...
      return underscore__WEBPACK_IMPORTED_MODULE_3__["default"].isString(filterProp()) ? _babel_runtime_corejs3_core_js_stable_instance_trim__WEBPACK_IMPORTED_MODULE_1___default()(_context = filterProp()).call(_context) : filterProp();
    };

    return filterProp;
  },
      getters = _babel_runtime_corejs3_core_js_stable_instance_reduce__WEBPACK_IMPORTED_MODULE_0___default()(underscore__WEBPACK_IMPORTED_MODULE_3__["default"]).call(underscore__WEBPACK_IMPORTED_MODULE_3__["default"], attributes, function (memo, operator, attr) {
    ...
    return _babel_runtime_corejs3_core_js_stable_instance_reduce__WEBPACK_IMPORTED_MODULE_0___default()(underscore__WEBPACK_IMPORTED_MODULE_3__["default"]).call(underscore__WEBPACK_IMPORTED_MODULE_3__["default"], getters, function (memo, getter, attr) {
      if (attr !== 'order') {
        var operator = attributes[attr];

        if (underscore__WEBPACK_IMPORTED_MODULE_3__["default"].isFunction(getter.toFilter) && (getter.toFilter() === undefined || getter.toFilter() === '')) {
          return memo;
    ...
    var order = function order() {
      return getters.order() && _babel_runtime_corejs3_core_js_stable_instance_reduce__WEBPACK_IMPORTED_MODULE_0___default()(underscore__WEBPACK_IMPORTED_MODULE_3__["default"]).call(underscore__WEBPACK_IMPORTED_MODULE_3__["default"], getters.order(), function (memo, direction, attr) {
    ...
    return underscore__WEBPACK_IMPORTED_MODULE_3__["default"].extend({}, orderParameter, parametersWithoutOrder());
  };

  return underscore__WEBPACK_IMPORTED_MODULE_3__["default"].extend(newVM, getters, {
    parameters: parameters,
    parametersWithoutOrder: parametersWithoutOrder
  });
};

/* harmony default export */ __webpack_exports__["default"] = (filtersVM);

/***/ }),

/***/ "./src/vms/paginationVM.js":
/*!*********************************!*\
  !*** ./src/vms/paginationVM.js ***!
  \*********************************/
/*! exports provided: default */
...
/* harmony import */ var mithril_stream__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! mithril/stream */ "./node_modules/mithril/stream.js");
/* harmony import */ var mithril_stream__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(mithril_stream__WEBPACK_IMPORTED_MODULE_4__);
...
var paginationVM = function paginationVM(mithilInstance) {
  ...
  return function (model, order) {
    ...
    var collection = mithril_stream__WEBPACK_IMPORTED_MODULE_4___default()([]),
        defaultOrder = order || 'id.desc',
        filters = mithril_stream__WEBPACK_IMPORTED_MODULE_4___default()({
      order: defaultOrder
    }),
        isLoading = mithril_stream__WEBPACK_IMPORTED_MODULE_4___default()(false),
        page = mithril_stream__WEBPACK_IMPORTED_MODULE_4___default()(1),
        resultsCount = mithril_stream__WEBPACK_IMPORTED_MODULE_4___default()(),
        pageRequest = authenticate ? model.getPageWithToken : model.getPage,
        total = mithril_stream__WEBPACK_IMPORTED_MODULE_4___default()();

    var fetch = function fetch() {
      return new _babel_runtime_corejs3_core_js_stable_promise__WEBPACK_IMPORTED_MODULE_3___default.a(function (resolve, reject) {
        var getTotal = function getTotal(xhr) {
          if (!xhr || xhr.status === 0) {
            return _babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_2___default()({
              hint: null,
              details: null,
              code: 0,
          ...
          if (underscore__WEBPACK_IMPORTED_MODULE_5__["default"].isString(rangeHeader)) {
            var _rangeHeader$split = rangeHeader.split('/'),
                _rangeHeader$split2 = _babel_runtime_corejs3_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1___default()(_rangeHeader$split, 2),
                headerSize = _rangeHeader$split2[0],
                headerCount = _rangeHeader$split2[1],
                _headerSize$split = headerSize.split('-'),
                _headerSize$split2 = _babel_runtime_corejs3_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1___default()(_headerSize$split, 2),
                headerFrom = _headerSize$split2[0],
                headerTo = _headerSize$split2[1],
                to = _babel_runtime_corejs3_core_js_stable_parse_int__WEBPACK_IMPORTED_MODULE_0___default()(headerTo) + 1 || 0,
                from = _babel_runtime_corejs3_core_js_stable_parse_int__WEBPACK_IMPORTED_MODULE_0___default()(headerFrom) || 0;

            total(_babel_runtime_corejs3_core_js_stable_parse_int__WEBPACK_IMPORTED_MODULE_0___default()(headerCount));
        ...
        pageRequest(filters(), page(), {
          ...
          collection(underscore__WEBPACK_IMPORTED_MODULE_5__["default"].union(collection(), data));
          isLoading(false);
          resolve(collection());
        }).catch(function (error) {
          isLoading(false);
      ...
      filters(underscore__WEBPACK_IMPORTED_MODULE_5__["default"].extend({
        order: defaultOrder
      }, parameters));
      collection([]);
      page(1);
...
/* harmony default export */ __webpack_exports__["default"] = (paginationVM);

/***/ })

/******/ });
});
//# sourceMappingURL=mithril-postgrest.js.map